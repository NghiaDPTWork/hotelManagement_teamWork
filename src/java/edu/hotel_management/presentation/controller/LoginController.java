...
<<<<<<< HEAD:src/java/edu/hotel_management/infrastructure/controller/LoginController.java
                String url = IConstant.PAGE_HOME;
                switch (userRole.toUpperCase()) {
=======
                String redirectUrl = IConstant.PAGE_HOME;
                switch (userRole) {
>>>>>>> ceb12419d611a5f985f89a588c802fe945e0e9ab:src/java/edu/hotel_management/presentation/controller/LoginController.java
                    case "ADMIN":
                        url = ""; 
                        break;
                    case "RECEPTIONIST":
