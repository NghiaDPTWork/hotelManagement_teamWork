...
<section id="rooms" class="section-padding bg-light">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-5 scroll-animate">
            ...
            <a href=" <%= IConstant.ACTION_ROOM_BOOKING%>" class="btn btn-outline-dark">View All</a>
        </div>
            ...
            <div class="col-lg-4 col-md-6 scroll-animate">
                <div class="card card-hover h-100 room-card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text text-muted small">Wake up to panoramic ocean views from your private balcony.
                            This room combines elegant furnishings with premium amenities for an unforgettable seaside escape.</p>
                        ...
                        <div class="mt-auto d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" 
                                    class="btn btn-warning view-detail-btn" 
                                    data-bs-toggle="modal" 
                                    data-bs-target="#roomDetailModal"
                                    data-room-id="1"
                                    data-room-name="Deluxe Ocean View"
                                    data-room-price="$250 / night"
                                    data-room-image="${pageContext.request.contextPath}/public/img/room-1.jpg">
                                View Detail
                            </button>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 scroll-animate" style="animation-delay: 0.4s;">
                <div class="card card-hover h-100 room-card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text text-muted small">Perfect for those who appreciate modern elegance, this room offers stunning views of the vibrant marina, 
                            complemented by a sleek, contemporary design.</p>
                        <ul class="room-amenities-list">
